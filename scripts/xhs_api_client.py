...
CANONICAL_OPERATIONS: dict[str, Operation] = {
    ...
    "notification-mentions": Operation("GET", "/api/v1/notifications/mentions", "service"),
...
OPERATION_ALIASES: dict[str, str] = {
    ...
    "user-me": "user-me",
    "notification-mentions": "notification-mentions",
    "comment": "comment",
    ...
    "get-notification-mentions": "notification-mentions",
    "get_notification_mentions": "notification-mentions",
